...
impl TryFrom<u32> for ChannelClass {
    ...
    fn try_from(val: u32) -> Result<Self> {
        ...
        match val {
            ...
            ffi::Phidget_ChannelClass_PHIDCHCLASS_MOTORPOSITIONCONTROLLER => Ok(MotorPositionController), // 34
            ffi::Phidget_ChannelClass_PHIDCHCLASS_MOTORVELOCITYCONTROLLER => Ok(MotorVelocityController), // 39
