...
extern "C" {
    pub fn PhidgetMotorPositionController_getMinBrakingStrength(
        ch: PhidgetMotorPositionControllerHandle,
        minBrakingStrength: *mut f64,
    ) -> PhidgetReturnCode;
}
extern "C" {
    pub fn PhidgetMotorPositionController_getMaxBrakingStrength(
        ch: PhidgetMotorPositionControllerHandle,
        maxBrakingStrength: *mut f64,
    ) -> PhidgetReturnCode;
}
...
extern "C" {
    pub fn PhidgetMotorPositionController_setTargetBrakingStrength(
        ch: PhidgetMotorPositionControllerHandle,
        targetBrakingStrength: f64,
    ) -> PhidgetReturnCode;
}
extern "C" {
    pub fn PhidgetMotorPositionController_getTargetBrakingStrength(
        ch: PhidgetMotorPositionControllerHandle,
        targetBrakingStrength: *mut f64,
    ) -> PhidgetReturnCode;
}
